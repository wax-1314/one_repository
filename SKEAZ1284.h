...
} volatile FTMRE_Type, *FTMRE_MemMapPtr;
...
} volatile MCM_Type,*MCM_MemMapPtr;
...
} volatile MSCAN_Type,*MSCAN_MemMapPtr;
...
} volatile *PMC_MemMapPtr,PMC_Type;
...
} volatile *SCB_MemMapPtr,SCB_Type;
